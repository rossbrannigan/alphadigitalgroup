...
const India: React.FC = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Case Studies and Insights: India</h1>
      
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Featured Topic: </h2>
        <p className="mb-4">
          Explore the world of ----- India's unique general trading companies that play a crucial role in the country's economy and international trade.
        </p>
