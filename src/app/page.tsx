...
<div className="container mx-auto py-8">
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
    <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col justify-center items-center">
      <img src="digital-product-logo.png" alt="Digital Product Placeholder" className="mb-4" />
    ...
    <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col justify-center items-center">
      <img src="digital-marketing-logo.png" alt="Digital Marketing Placeholder" className="mb-4" />
    ...
    <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col justify-center items-center">
      <img src="aviation-management-logo.png" alt="Aviation Management Placeholder" className="mb-4" />
